...
public class MotorCycle extends Vehicle
{
    ...
    @Override
    public void print() {
        System.out.println(getVehicleIdentificationNumber()+" "+getVehicleDescription()+" "+getManufacturerName()+" "+getSelfDrive()+" "+getInsured()+" "+getInsuranceProviderName()+" "+getNoOfSeat()+" "+getFuelType()+" "+getBaseRate()+" "+getRatePerKm()+" "+getMaxTopSpeed()+" "+getMaxTopSpeed());
